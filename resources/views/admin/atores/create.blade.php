...
<form action="{{ route('atores.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        <label for="biografia" class="font-weight-bold">Biografia</label>
    ...
    <div class="row">
        <div class="form-group col-3">
            ...
            <input type="number" class="form-control" name="idade" min="16" max="110" step="1" placeholder="Informe a idade" value={{old('idade')}}>
        </div>
        <div class="form-group col-3">
