...
<form action="{{ route('produtoras.store') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <textarea name="historia" id="" cols="30" rows="5" class="form-control {{($errors->has('historia') ? 'is-invalid' : '' )}}" placeholder="Informe a breve história à produtora">{{ old('historia')}}
        </textarea>
        <div class="invalid-feedback">
